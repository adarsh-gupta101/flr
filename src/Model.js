...
export default function Model({ scroll, ...props }) {
  ...
  // const { nodes, materials, animations } = useGLTF("/model.glb")
    const { nodes, materials, animations } = useGLTF("./block_1.glb")
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group
        ...
        <mesh name="Headphones" geometry={nodes.r1_11x9B_1.geometry} material={materials.M_Headphone} {...extras} />
...
useGLTF.preload("/loaders/block_.1.gltf")